...
public class VuforiaSignatureUtil {

    public static String tmsSignature(HttpUriRequest request, String secretKey) {
    ...
    private static String contentMD5(HttpEntityEnclosingRequestBase httpMethod) {
