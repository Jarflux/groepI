        ...
        <form method="post" action="create" class="mainstyle tooltips validate">
            <div class="row">
                ...
                <input type="text" class="required" name="name" placeholder=""
                       title="Gelieve uw volledige naam in te geven"/>
            </div>
            <div class="row">
                <span><spring:message code='text.password'/></span>
                <input type="password" class="required equalsto" equalsto="password2" name="password" placeholder=""
                       title="Kies een sterk wachtwoord"/>
            </div>
            <div class="row">
                <span><spring:message code='text.repeatpassword'/></span>
                <input type="password" class="required equalsto" equalsto="password" name="password2" placeholder=""
